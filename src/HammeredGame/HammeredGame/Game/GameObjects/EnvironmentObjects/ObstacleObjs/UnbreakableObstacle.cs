...
namespace HammeredGame.Game.GameObjects.EnvironmentObjects.ObstacleObjs
{
    ...
    public class UnbreakableObstacle : ObstacleObject
    {
        ...
        public UnbreakableObstacle(GameServices services, Model model, Texture2D t, Vector3 pos, Quaternion rotation, float scale) : base(services, model, t, pos, rotation, scale)
        {
        }
